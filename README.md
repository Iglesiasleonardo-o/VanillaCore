...
* **Core Logic:** Check [`public/js/vanilla-core/README.md`](https://github.com/Iglesiasleonardo-o/VanillaCore/tree/main/public/js/vanilla-core) for the ViewGenCore documentation, including how it functions and various usage examples.
