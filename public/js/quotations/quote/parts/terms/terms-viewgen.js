...
export function PaymentMethodModal(selectedList, availableList) {
    ...
    paymentMethodModal.Append(
        div({
            ...
            ModalHeader(paymentMethodModal),
            ModalBody(selectedList, availableList),
            ModalFooter(paymentMethodModal)
        )
    );
...
// MODAL HEADER
function ModalHeader(paymentMethodModal) {
    return header({
...
function ModalBody(selectedAccountsView, availableAccountsView) {
    return div({
...
function ModalFooter(paymentMethodModal) {
    return footer({
