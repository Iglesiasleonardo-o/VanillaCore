...
import { ItemsTableWidget, TotalsWidget, ItemsModal, QuoteRow, ProductSearchItem, EmptyTableState, EmptySearchState, LoadingState, BottomLoader, getActionIcon } from "./items-viewgen.js";
...
function observeState(state, tableViews, totalsViews, modalViews, events, draftStates) {
    ...
    const updateSearchItemUI = (views, dbProduct, cartItem) => {
        ...
        views.btnAction.replaceChildren(getActionIcon(isAdded));
